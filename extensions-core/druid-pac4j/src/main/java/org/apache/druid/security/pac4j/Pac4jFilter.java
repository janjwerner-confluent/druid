...
public class Pac4jFilter implements Filter
{
  ...
  private static final HttpActionAdapter<String, JEEContext> NOOP_HTTP_ACTION_ADAPTER = (int code, JEEContext ctx) -> null;
      ...
      throws IOException, ServletException
  {
    ...
    if (Pac4jCallbackResource.SELF_URL.equals(httpServletRequest.getRequestURI())) {
      ...
      String uid = securityLogic.perform(
          context,
          pac4jConfig,
          (JEEContext ctx, Collection<CommonProfile> profiles, Object... parameters) -> {
            if (profiles.isEmpty()) {
